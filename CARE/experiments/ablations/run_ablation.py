"""
experiments/ablations/run_ablation.py — CARE ablation experiments

3 variants (share one CF backbone per seed):
  A1: CARE       — CF + raw CLIP text fusion on cold-start items
...
from losses.care_loss     import care_total_loss
    ...
    for epoch in range(1, cfg["max_epochs"] + 1):
        ...
        for start in range(0, n_train, cfg["batch_size"]):
            ...
            with autocast("cuda", enabled=use_amp):
                ...
                loss, info = care_total_loss(outputs, margin=current_margin)
...
VARIANTS = {
    "A1": {"name": "CARE",          "desc": "CF + raw CLIP text fusion"},
